...
frame2 = tk.Frame(window, bg="#f5f5dc")
frame2.place(relx=0.11, rely=0.17, relwidth=0.80, relheight=0.80)
...
head2 = tk.Label(frame2, text="                        For New Registration                         ", fg="black",bg="#f5f5dc" ,font=('times', 17, ' bold ') )
head2.place(x=250,y=1)



lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="#f5f5dc" ,font=('times', 17, ' bold ') )
lbl.place(x=350, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=350, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="#f5f5dc" ,font=('times', 17, ' bold '))
lbl2.place(x=350, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold ')  )
txt2.place(x=350, y=173)

message1 = tk.Label(frame2, text="1)Take Images   2)Save Profile" ,bg="#f5f5dc" ,fg="black"  ,width=39 ,height=1, activebackground = "brown" ,font=('times', 15, ' bold '))
message1.place(x=300, y=230)

message = tk.Label(frame2, text="" ,bg="#f5f5dc" ,fg="black"  ,width=39,height=1, activebackground = "brown" ,font=('times', 16, ' bold '))
message.place(x=300, y=450)
...
tv= ttk.Treeview(frame2,height =13,columns = ('name','date','time'))
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="floralwhite"  ,bg="peru"  ,width=11 ,activebackground = "white" ,font=('times', 11, ' bold '))
clearButton.place(x=700, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="floralwhite"  ,bg="peru"  ,width=11 , activebackground = "white" ,font=('times', 11, ' bold '))
clearButton2.place(x=700, y=172)    
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages  ,fg="floralwhite"  ,bg="peru"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
takeImg.place(x=300, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw ,fg="floralwhite"  ,bg="peru"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
